...
* **basics** - Contains examples of basic technologies used in the project. Each technology is addressed by a directory. This direct has only learning purposes, i.e., it does not contain code of the system.
...
* **notebook** - Main directory, it contains the code of the whole notebook (client and server). This directory is detailed at: [Notebook README](notebook/README.md).
...
## Running Jupyter for \[basics\] examples

The previous version of the system ran over Jupyter. In the current version, only the REST server runs over Jupyter, but also the server has been migrated to another solution. Therefore, the Jupyter here is used to run examples in the \[basics\] directory, which illustrates technologies adopted in some aspects of the system.

### Jupyter using mybinder.org
