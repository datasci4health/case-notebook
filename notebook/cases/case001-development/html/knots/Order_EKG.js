...
<dcc-trigger id='dcc3' type='++' link='Generate_hypothesis_2' label='Generate hypothesis'  location='action-1'></dcc-trigger>
<dcc-trigger id='dcc5' type='++' link='More_information_2' label='More information'  location='action-2'></dcc-trigger>
<dcc-trigger id='dcc7' type='++' link='Call_the_supervisor_2' label='Call the supervisor'  location='action-3'></dcc-trigger></p>
<p><dcc-trigger id='dcc9' type='++' link='Magnify_EKG' label='Magnify'  location='ekg-image'></dcc-trigger></p>
       </dcc-styler>
     </div>
  </foreignObject>
  <rect
